    ...
    <div>
      ...
      <section className="w-full bg-gray-100 min-h-screen py-16 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-12">
          ...
          {/* Right Form Panel */}
          <div className="w-full md:w-7/12 bg-white rounded-xl p-4 md:p-8 flex flex-col gap-4 shadow-sm">
            <Formik
              initialValues={{
                fullName: "",
                phoneNumber: "",
              ...
              {({
                ...
                <Form>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 mt-2">
                    ...
                    <div className="flex flex-row flex-1 gap-2 mt-2 sm:mt-0 items-center">
                      {/* Captcha Display */}
                      ...
                      <button
                        ...
                        className="ml-1 flex items-center justify-center w-12 h-12 rounded-md flex-shrink-0 transition hover:opacity-90"
